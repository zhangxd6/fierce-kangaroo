...
export default class Post extends React.Component {
    render() {
        return (
            <Layout {...this.props}>
              {(this.props.pageContext.frontmatter.hide_header === true) ? 
                <HeaderAlt {...this.props} />
               : 
                <Header {...this.props} site={this.props.pageContext.site} page={this.props.pageContext} img_path={this.props.pageContext.frontmatter.content_img_path} />
              }
              <div id="content" className="site-content">
                ...
                <Footer {...this.props} site={this.props.pageContext.site} page={this.props.pageContext} img_path={this.props.pageContext.frontmatter.content_img_path} />
              </div>
            </Layout>
        );
    }
