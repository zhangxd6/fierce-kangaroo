...
export default class Contact extends React.Component {
    render() {
        return (
            <Layout {...this.props}>
              <Header {...this.props} site={this.props.pageContext.site} page={this.props.pageContext} img_path={this.props.pageContext.frontmatter.img_path} />
              <div id="content" className="site-content">
                ...
                <Footer {...this.props} site={this.props.pageContext.site} page={this.props.pageContext} img_path={this.props.pageContext.frontmatter.img_path} />
              </div>
            </Layout>
        );
    }
